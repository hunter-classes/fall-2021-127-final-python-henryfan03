...
def tests():
  ...
  print("numConvert([0,0,7]):",numConvert([0,0,7]),"Expected:",5)
  print("numConvert([0,2,0]):",numConvert([0,2,0]),"Expected:",10)
  print("numConvert([1,0,0]):",numConvert([1,0,0]),"Expected:",600)
